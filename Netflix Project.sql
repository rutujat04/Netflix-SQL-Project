...
count(show_id) from netflix group by 1
order by 2 desc --2 is the second column i.e show_id
limit 5;
unnested --> converts into single row
split_part --> split the words based on condition
...
-- ilike for any small capital letters
